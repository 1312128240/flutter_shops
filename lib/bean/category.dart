class Category {
  ...
  Category({this.code, this.message, this.CategorydataList});

  Category.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    if (json['data'] != null) {
      CategorydataList = new List<CategoryDataList>();
      json['data'].forEach((v) {
        CategorydataList.add(new CategoryDataList.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.CategorydataList != null) {
      data['data'] = this.CategorydataList.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
